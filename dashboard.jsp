    ...
    <div id="wrapper">
        <div id="sidebar-wrapper" style="background-color:#f77f00; overflow:hidden">
            <ul class="sidebar-nav nav">
                <li class="sidebar-brand nav-item"> <a class="d-inline-block" style="color:rgb(255,255,255);width:250px;margin-left:-20px;"><i class="fa fa-user-circle" style="font-size:18px;width:38px;margin-right:0px;margin-left:0px;"></i><strong>&nbsp; <% out.println(session.getAttribute("username")); %> </strong></a></li>
                <li>
                <a class="d-block" href="#tab-3" style="color:rgb(255,255,255);width:250px;" role="tab" data-toggle="tab"><i class="fa fa-newspaper-o" style="text-align:center"></i>&nbsp;Latest News</a></li>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card"><span class="card-img-top w-100 d-block "><i class="fa fa-user-circle text-center" style="font-size:70px;margin-right:0px;margin-left:90px;"></i></span>
                <div class="card-body">
                    <h4 class="card-title"><% out.println(session.getAttribute("username")); %></h4>
        ...
        <div class="col">
            ...
            <form>
                ...
                <div class="form-group">
                    <h5>Current Address</h5><textarea placeholder="Address" class="form-control"></textarea></div>
                <div class="form-group">
                    <h5>Permanent Address</h5><textarea placeholder="Address" class="form-control"></textarea></div>
                 <div class="form-group">
